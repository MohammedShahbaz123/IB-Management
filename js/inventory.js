...
async function loadInventoryProducts() {
    ...
    try {
        ...
        if (stockStatus === 'out_of_stock') {
            ...
            console.log('📊 Filtering: In stock');
    ...
    if (searchInput) {
        searchInput.addEventListener('input', debounce((e) => {
            ...
            items.forEach(item => {
                ...
                const productSku = item.querySelector('.sku').textContent.toLowerCase();
                const productCategory = item.querySelector('.category').textContent.toLowerCase();
